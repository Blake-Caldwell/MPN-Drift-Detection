...
function ResultsContent() {
  ...
  return (
            ...
            <Card key={job.jobId}>
              ...
              <CardFooter className="flex justify-between">
                <Button
                  ...
                  variant="ghost"
                  className="text-s h-8 underline"
                >
                  Download
                </Button>
    ...
    <main className=" ml-96 flex-grow mt-0.5 pt-1.5">
      <div className="p-10 bg-gray-700 bg-opacity-70 shadow-gray-700 shadow-xl rounded-xl">
        {selectedJobId ? (
    ...
    //   }`}
    // >
    // {/* <aside className=" bg-gray-700 p-4 text-white fixed h-full z-40"> */}
    //     <ScrollArea>
    //       <div className="cards-container flex flex-col space-y-4 bg-transparent">
    //         <div className="flex justify-between">
    //           <Button variant="default" className=" text-xs h-8">
    ...
    //             </svg>
    //           </Button> */}
    //           <Label color="#dae4ec" className="opacity-90 mt-2"> MPN Drift Detector</Label>
    //         </div>
    ...
    //   </aside>
    //   <main
    //   className={`content col-start-2 col-span-full transition-all duration-600 ease-in-out ${
    //     isAsideVisible ? "ml-4" : "col-start-1 col-span-full"
    //   }`}
    // >
    // {/* <main className="w-4/5 ml-4 pl-80"> */}
